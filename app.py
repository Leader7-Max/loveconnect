...
# Rafraîchissement automatique toutes les 3 secondes pour actualiser le fil de discussion
...
# Styles CSS épurés et modernes pour mobile et desktop
st.markdown("""
<style>  
...
if st.session_state.logged_in:
    ...
    with tab_messages:
        ...
        if not matches:
            ...
            with col_chat:
                # Si aucun contact sélectionné, on prend le premier de la liste par défaut
