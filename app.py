...
if st.session_state.logged_in:
    ...
    st.info(
        "🔜 Prochaine étape : découvrir les profils compatibles."
    )
...
# =========================================================
    ...
    inscription_tab, connexion_tab = st.tabs(
        ["❤️ Créer mon profil", "🔐 Se connecter"]
    )
        ...
        if submitted:
            ...
            if not first_name.strip():
                ...
                if success:
                    st.success("🎉 " + message)
                    st.info(
                        "Vous pouvez maintenant utiliser l'onglet "
                        "« 🔐 Se connecter »."
                    )
                else:
                    st.error("❌ " + message)
    ...
    with connexion_tab:
        ...
        st.markdown("### 🔐 Connexion à LoveConnect")
